...
if (isset($_POST['simpan'])) {
  ...
  $id_jabatan_coba = $_POST['id_jabatan_coba'];
...
//proses hapus gambar
      ...
      $sql_f = "UPDATE tb_karyawan set username='$username', password='$password', nama='$nama', tmp_tgl_lahir='$tmp_tgl_lahir', jenkel='$jenkel', agama='$agama', alamat='$alamat', no_tel='$no_tel', id_jabatan_coba='$id_jabatan_coba', foto ='$fotobaru' WHERE id_karyawan='$id_karyawan'";
   ...
   $sql_d   = "UPDATE tb_karyawan set username='$username', password='$password', nama='$nama', tmp_tgl_lahir='$tmp_tgl_lahir', jenkel='$jenkel', agama='$agama', alamat='$alamat', no_tel='$no_tel', id_jabatan_coba='$id_jabatan_coba' WHERE id_karyawan='$id_karyawan'";
