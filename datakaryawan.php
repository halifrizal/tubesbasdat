                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="images/icon/logo.png" alt="MasihLoading"/>
                        </a>
                                ...
                                <table class="table table-borderless table-striped table-earning" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Jabatan</td>
                                                <td>
                                                <select class="form-control" name="id_jabatan_coba" required="">
                                                <?php 
                                                ...
                                                while ($data = mysqli_fetch_array($hasil)) {
                                                 ?>
                                                <option value="<?php echo $data['jabatan_coba'];?>"><?php echo $data['jabatan_coba']; ?></option>
                                                <?php } ?>
